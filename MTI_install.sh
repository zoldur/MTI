...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='MTI.conf'
CONFIGFOLDER='/root/.MTI'
COIN_DAEMON='MTId'
COIN_CLI='MTId'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/mticryptocoins/MTI-Coin/files/1829112/MTId-.Linux_Daemon.tar.gz'
...
function download_node() {
  ...
  compile_error
  strip ./$COIN_DAEMON >/dev/null 2>&1
